        ...
        <div className="instruction__body">
            <div className="instruction__text">
                ...
                <div className="instruction__p">
                    <Tree p1={<p>Arrive at the quiz platform at least 15 minutes before quiz the start</p>} p2={<p>Be aware that the quiz is on counting down</p>} p3={<p>If you face technical problems during the quiz, contact invigilators.</p>} p4={<p>Attempt all question</p>} p5={<p>Thank you</p>} />
